...
正向代理关注的是客户端的安全性，他在客户端和服务端充当中间人角色，服务端无法知晓具体的客户端，统一有代理作为出口

常见场景：
- 突破网络限制，通过代理来访问无法直接访问的网站和服务 如VPN
- 网络安全 监控和管理员工的网络行为，隐藏公司内部真实IP，防止数据泄漏
- 内容过滤 学校等公共场所过滤不良内容
- 提高访问速度 在代理中添加缓存，提高访问速度

### 1.2 反向代理

反向代理同样作为客户端和服务端的中间人角色，但相反的是：客户端无法知晓具体的服务端是谁，有代理侧进行负载均衡进行服务分发

常见场景：
- web应用 常见的负载均衡、访问控制、缓存优化
- API网关 对外部请求进行统一调度
- CDN加速 通过在全球部署代理服务，加速内容的就近反问和传输速度

一个是针对客户端（有客户端部署维护），一个是针对服务端（由服务端部署维护）
